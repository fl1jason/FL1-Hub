...
extern void *mono_aot_module_MasterDetailPageNavigationiOS_info;
...
extern void *mono_aot_module_HuubApp_info;
...
{
	mono_aot_register_module (mono_aot_module_MasterDetailPageNavigationiOS_info);
	...
	mono_aot_register_module (mono_aot_module_HuubApp_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "MasterDetailPageNavigationiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
