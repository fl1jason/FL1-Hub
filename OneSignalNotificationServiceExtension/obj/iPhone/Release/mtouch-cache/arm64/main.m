...
extern void *mono_aot_module_OneSignalNotificationServiceExtension_info;
...
{
	mono_aot_register_module (mono_aot_module_OneSignalNotificationServiceExtension_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "OneSignalNotificationServiceExtension.dll";
	mono_use_llvm = TRUE;
	xamarin_log_level = 0;
...
int main (int argc, char **argv)
{
	...
	argv [0] = (char *) "OneSignalNotificationServiceExtension";
